<?php
    ...
    class OAuthRequest{
        ...
        public function get_user_profile(){
			...
			$em = (string)$xml -> response -> email;
			$emid = explode("@", $em);
			
            $this -> userInfo = array('userID' => $emid[0], 'nickname' => (string)$xml -> response -> nickname, 'age' => (string)$xml -> response -> age, 'birth' => (string)$xml -> response -> birthday, 'gender' => (string)$xml -> response -> gender, 'profImg' => (string)$xml -> response -> profile_image );
