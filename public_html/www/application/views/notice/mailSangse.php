...
?>
      ...
      <div class="tab">
        <ul>
          <li class="on"><a href="#">메일 상세보기</a></li>
        </ul>
      </div>
      <!-- //tab -->
    ...
    <div id="join_mem" class="join_mem finder_div" style="position:relative; width:100%; padding:0; margin:10px 0 10px; border:none; display:block;">
      ...
      <tr><td class="titcell">수신자</td><td>
      
      <?
	  $sn = "";
	  foreach($susin as $srow){
	  	$sn .= $srow->name."( ".$srow->email." ) / ";
	  }
		echo $sn;
	  ?>
      ...
      <tr><td class="titcell">수신일시</td><td><?=$mess->onday?></td></tr>
 		...
 		<div style="width:755px; text-align:right;"><a href="<?=$baseUrl?>gongji/getView/2/1" class="btn_gray"><span>목록</span></a></div>
