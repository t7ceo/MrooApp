...
<input type="hidden" name="gubun" value="<?=$onmd?>" />
...
<input type="hidden" id = "mkbd" name="mkbd" value="<?=$this->session->userdata('bdid')?>">
        ...
        <tr><th><span class="pilsu">*</span><span>제목 :</span></th><td>
            <input type="text" name="tit" style="width:50%; padding:1px 0; margin:2px 10px 2px 0; border:#ccc 1px solid;" value="" />
        </td></tr>
    ...
    <textarea name="ir1" id="ir1" rows="10" cols="100" style="width:99%; margin:0; height:250px;"></textarea>
	...
	<p style="padding:12px 3%; width:96%; text-align:center;">
        ...
        <a href="<?=$baseUrl?>community/getView/<?=$md?>/1/" class="btn_gray"><span>목록</span></a>
